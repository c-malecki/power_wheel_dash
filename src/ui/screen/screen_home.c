...
static void input_event_cb(lv_event_t *lv_event) {
  ...
  lv_subject_set_int(&subject_pending_screen_id, screen_id);
}
...
void Home_Screen_Init(void) {
  ...
  lv_obj_add_event_cb(light_button, input_event_cb, LV_EVENT_CLICKED,
  ...
  lv_obj_add_event_cb(sound_button, input_event_cb, LV_EVENT_CLICKED,
